...
@RunWith(JMock.class)
public class TestMoveRight extends MoveRight {
	...
	public void test_getFurturePoint_point() throws Exception {
		...
		assertThat(result, equalTo(new Point(4,4)));
		
	}
	
	@Test
	public void test_getActivityInitLogMsg() throws Exception{
		assertThat(getActivityInitLogMsg(), equalTo("Moving Right"));
	}
		...
		context.checking(new Expectations() {
			{
				...
				oneOf(movementApparatus).moveRight();
			}
		});
