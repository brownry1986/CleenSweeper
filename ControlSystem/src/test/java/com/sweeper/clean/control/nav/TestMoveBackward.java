...
@RunWith(JMock.class)
public class TestMoveBackward extends MoveBackward {
	...
	public void test_getFurturePoint_point() throws Exception {
		...
		assertThat(result, equalTo(new Point(3,3)));
		
	}
	
	@Test
	public void test_getActivityInitLogMsg() throws Exception{
		assertThat(getActivityInitLogMsg(), equalTo("Moving Backwards"));
	}
		...
		context.checking(new Expectations() {
			{
				...
				oneOf(movementApparatus).moveBackward();
			}
		});
