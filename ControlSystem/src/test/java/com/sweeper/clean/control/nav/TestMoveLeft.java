...
@RunWith(JMock.class)
public class TestMoveLeft extends MoveLeft {
	...
	public void test_getFurturePoint_point() throws Exception {
		...
		assertThat(result, equalTo(new Point(2,4)));
		
	}
	
	@Test
	public void test_getActivityInitLogMsg() throws Exception{
		assertThat(getActivityInitLogMsg(), equalTo("Moving Left"));
	}
		...
		context.checking(new Expectations() {
			{
				...
				oneOf(movementApparatus).moveLeft();
			}
		});
